          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12">
                <Link to="/get-started" className="w-full sm:w-auto px-8 py-4 bg-boost-accent text-boost-dark rounded-xl font-bold text-lg hover:bg-boost-accentHover transition-all shadow-[0_0_25px_rgba(0,223,162,0.4)] hover:shadow-[0_0_35px_rgba(0,223,162,0.6)] flex items-center justify-center gap-2 group">
                  Get Started Free
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link to="/chatbot-demo" className="w-full sm:w-auto px-8 py-4 bg-white/5 text-white border border-white/10 rounded-xl font-bold text-lg hover:bg-white/10 transition-all backdrop-blur-sm flex items-center justify-center gap-2">
